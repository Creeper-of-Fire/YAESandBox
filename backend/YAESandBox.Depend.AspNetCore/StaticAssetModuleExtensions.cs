...
public static class StaticAssetModuleExtensions
{
    ...
    /// <param name="requestPath">前端访问此资源的 URL 路径。如果为 null，则默认为 "/plugins/{ModuleName}"。</param>
    public static void UseModuleWwwRoot(this IApplicationBuilder app, IProgramModule module, string? requestPath = null)
    {
        ...
        {
            requestPath = module.ToRequestPath();
        }
