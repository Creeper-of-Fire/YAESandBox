...
public static class MappingUtility
{
    ...
    private static readonly IReadOnlyDictionary<BlockDetailFields, Func<BlockDetailDto, Seed.Block.Block, BlockDetailDto>> FieldUpdaters =
        new Dictionary<BlockDetailFields, Func<BlockDetailDto, Seed.Block.Block, BlockDetailDto>>
        {
    ...
    /// <returns></returns>
    public static BlockDetailDto CreatePartial(this Seed.Block.Block block, params BlockDetailFields[] fields)
    {
        // 初始 DTO 只包含 BlockId
    ...
    /// </summary>
    public static WorkflowDto MapToWorkflowDto(this Seed.Block.Block block)
    {
