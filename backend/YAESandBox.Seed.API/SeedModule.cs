...
using YAESandBox.Seed.API.Hubs;
using YAESandBox.Seed.API.Services;
using YAESandBox.Seed.Block.BlockManager;
using YAESandBox.Seed.DTOs;
using YAESandBox.Seed.DTOs.WebSocket;
using YAESandBox.Seed.Services;
using YAESandBox.Seed.Services.InterFaceAndBasic;
using YAESandBox.Seed.Services.WorkFlow;
using YAESandBox.Depend;
using YAESandBox.Depend.AspNetCore;

namespace YAESandBox.Seed.API;

/// <summary>
/// 游戏模块-Seed
/// </summary>
public class SeedModule : IProgramModule, IProgramModuleSwaggerUiOptionsConfigurator, IProgramModuleMvcConfigurator,
