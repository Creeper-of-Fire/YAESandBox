...
public class StringOptionsProcessor : ISchemaProcessor
{
    ...
    public void Process(SchemaProcessorContext context)
    {
        ...
        var attribute = context.ContextualType.GetContextAttribute<StringOptionsAttribute>(true);
        ...
        if (attribute.Options.Length > 0)
        {
            ...
            foreach (var val in attribute.Options.Select(o => o.Value))
            {
            ...
            context.Schema.ExtensionData["enumNames"] = attribute.Options.Select(o => o.Label).ToList();
        }
        ...
        if (!string.IsNullOrWhiteSpace(attribute.OptionsProviderEndpoint))
        {
            ...
            uiOptions["remoteSearchEndpoint"] = attribute.OptionsProviderEndpoint;
        }
