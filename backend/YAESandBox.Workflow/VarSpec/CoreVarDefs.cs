...
public static class CoreVarDefs
{
    ...
    /// </summary>
    public static VarSpecDef Any { get; } = new("Any", 
    ...
    /// </summary>
    public static VarSpecDef String { get; } = new("String", 
    ...
    /// </summary>
    public static VarSpecDef Number { get; } = new("Number", 
    ...
    /// </summary>
    public static VarSpecDef Boolean { get; } = new("Boolean", 
    ...
    /// </summary>
    public static VarSpecDef StringList { get; } = new("String[]", 
        "字符串数组：一个只包含字符串元素的有序列表。");
    
    /// <summary>
    /// **数字数组 (Number[])**: 一个只包含数字元素的有序列表。
    /// <para>用于处理一系列ID、数值数据点等。</para>
    /// </summary>
    public static VarSpecDef NumberList { get; } = new("Number[]", 
        "数字数组：一个只包含数字元素的有序列表。");
    ...
    /// </summary>
    public static VarSpecDef AnyList { get; } = new("Any[]", 
        "任意类型数组：一个可以包含任何类型元素的有序列表。");
    ...
    /// </summary>
    public static VarSpecDef RecordStringAny { get; } = new("Record<String, Any>", 
        "记录/字典：一个键为字符串，值为任意类型的键值对集合，非常适合表示通用的数据对象。");
    ...
    /// </summary>
    public static VarSpecDef JsonString { get; } = new("JsonString", 
    ...
    /// </summary>
    public static VarSpecDef PromptList { get; } = new("PromptList",
        "提示词列表：一个结构化的、用于与AI模型交互的提示词对象列表。");
}