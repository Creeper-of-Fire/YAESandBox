        ...
        <div v-if="config" :style="{ padding: isExpanded && config ? '12px 16px' : '0' }">
          <n-spin :show="isLoadingAiConfigSets">
            ...
            <div style="margin-top: 16px; text-align: right;">
              <n-button tertiary size="small" @click="showEditorPanel = !showEditorPanel">
                <template #icon>
...
import { NAlert, NButton, NCard, NCollapseTransition, NFlex, NFormItemRow, NIcon, NPopconfirm, NPopover, NSelect, NSpin, NSwitch, NText, NMessageProvider, NDialogProvider } from 'naive-ui';
import { Add as AddIcon, TrashOutline as DeleteIcon, ChevronUp as KeyboardArrowUpIcon, ChevronDown as KeyboardArrowDownIcon, SettingsOutline as SettingsIcon } from '@vicons/ionicons5';
