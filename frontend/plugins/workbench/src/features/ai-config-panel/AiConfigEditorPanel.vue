      ...
      <n-flex size="large" vertical>
        ...
        <n-card title="AI 配置集管理">
          <n-flex align="center" justify="space-between" style="margin-bottom: 16px;">
            ...
            <n-flex>
              <n-button :disabled="!canSaveChanges" type="primary" @click="handleSave">保存变更</n-button>
              <n-button @click="promptCreateNewSet">新建配置集</n-button>
              <n-button :disabled="!selectedUuid" @click="promptCloneSet">复制当前</n-button>
              <n-button :disabled="!selectedUuid" @click="promptRenameSet">修改名称</n-button>
              <n-popconfirm :disabled="!selectedUuid" @positive-click="executeDeleteSet">
                <template #trigger>
                  <n-button :disabled="!selectedUuid" type="error">删除当前</n-button>
                </template>
        ...
        <n-card v-if="currentConfigSet" title="AI 模型配置">
          <n-flex align="center" justify="space-between">
            ...
            <n-popconfirm @positive-click="handleRemoveCurrentAiConfig">
              <template #trigger>
                <n-button :disabled="!canRemoveCurrentAiConfig" tertiary type="warning">移除当前模型配置</n-button>
              </template>
